...
\title{ThorAI: An Open-Source MCP-Enabled Benchmarking Platform for\\ NVIDIA DRIVE Thor}
\author{ThorAI Platform Contributors\\
\texttt{github.com/yourusername/thor-ai-platform} --- \texttt{mcp.zaindroid.me/mcp}}
